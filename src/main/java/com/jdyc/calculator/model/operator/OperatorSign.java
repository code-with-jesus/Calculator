...
public class OperatorSign extends UnaryOperator {

	public OperatorSign() {
		super(Constants.SIGN);
	}

	@Override
	public void execute(CalculatorModel model) {
		Double newVal = Double.parseDouble(model.getDisplay()) * -1;
		model.setDisplay(String.valueOf(newVal));
